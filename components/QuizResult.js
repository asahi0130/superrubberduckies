...
function QuizResult({ b }) {
  ...
  return (
    <React.Fragment>
      <div
        className={`relative z-[-2] pt-8 pb-16 mx-8 px-6 rounded-lg shadow-xl  text-white text-2xl ${
          school == "Waseda University" ? "bg-[#8B3232]" : "bg-[#f1c500d3]"
        }`}
      >
        <div className="">
          <p className="mb-4">{school}</p>
          <li className="mb-16">{program}</li>
          ...
          <img
            ...
            src={`${
              school == "Waseda University"
                ? "/images/waseda-crop.png"
                : "/images/keio-crop.png"
            }`}
          />
        </div>
      </div>
